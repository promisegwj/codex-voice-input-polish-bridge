...
- `scripts/`: local service, bridge invocation, cross-platform publish helper, feedback learning iteration, cleanup, and optional task registration scripts.
...
- `docs/`, `CONTRIBUTING.md`, `ROADMAP.md`, `CHANGELOG.md`, `SECURITY.md`, `SUPPORT.md`, and `TypeWhisper-Codex-Workflow.md`: workflow, oral-to-standard text rules draft, cross-platform v0.3 notes, and maintenance documentation with local paths sanitized.
...
5. For v0.3, record whether macOS checks were real-machine tests or Windows cross-publish checks only.
